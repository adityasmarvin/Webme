...
<head>
  ...
  <!-- end: Css -->
  <link rel="shortcut icon" href="asset/img/tatalogam.png">
  ...
  if (isset($_POST['btn_masuk'])) {
    ...
    if ($select_isi >= 200) {
      ...
      if($cek_kode>=1) {
        ...
        echo "<script>alert('Muatan Tersebut Sudah Ada di Dalam Parkiran')</script>";
      }else{
        $sql = "INSERT INTO tb_daftar_parkir(kode, plat_nomor, Jenis_Muatan, Nama_Supir, jam_masuk, hitung_jam_masuk, status) VALUES('$kode', '$plat_nomor', '$Jenis_Muatan', '$Nama_Supir', '$jam_masuk', '$hitung_jam_masuk', '1')";
        ...
        <nav class="navbar navbar-default header navbar-fixed-top bg-teal">
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
                ...
                <img src="asset/img/tatalogam.png" alt="logo" style="float: left;margin-top: -10px;" width="35px"/>
                 <b style="float: left;margin-left: 4px;">E-Muat</b>
                </div>

              <ul class="nav navbar-nav search-nav" style="margin-left: 7%">
                  <li class="active"><a style="font-size: 18pt">Home</a></li>
                  <li><a href="daftar_Muatan.php?nama=<?= $username ?>"><span  style="font-size: 18pt">Daftar Muatan</a></span></li>
              </ul>
            ...
            <div class="col-md-12 col-sm-12 col-x-12" style="margin-top: 20px;">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading bg-teal">
                      <h4 style="color: white;font-size: 20pt;">Masuk Warehouse<span class="right" style="color : #f6c700; font-weight: bold; text-align: right; padding-right: 10px;">Empty : <?= $cek_sisa ?></span></h4>
                    </div>
                        ...
                        <form class="cmxform" method="POST">
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:10px !important;">
                              <input type="text" class="form-text" name="Nama_Supir" id="Nama_Supir" required>
                              <span class="bar"></span>
                          ...
                          <div class="col-md-6" style="padding-top: 10px">
                            <label><h4>Jenis Muatan</h4></label>
                          </div>

                          <div class="col-md-6" style="padding:5px 20px 0 25px" name="jenis_muatan">
                
                            <div class="form-animate-radio">
                              <label class="radio">
                                <input id="radio1" type="radio" name="jenis_muatan" value="A" required/>
                                <span class="outer">
                            ...
                            <div class="form-animate-radio">
                              <label class="radio">
                                <input id="radio2" type="radio" name="jenis_muatan" value="B" required/>
                                <span class="outer">
                                  <span class="inner"></span>
                                </span> B
                              </label>
                            ...
                            <div class="form-animate-radio">
                              <label class="radio">
                                <input id="radio3" type="radio" name="jenis_muatan" value="C" required/>
                                <span class="outer">
                                  <span class="inner"></span>
                                </span> C
                              </label>
              ...
              <!-- end:Masuk Parkir -->
              <!-- Daftar Muatan Yang Parkir -->          
                <div class="col-md-12 col-sm-12 col-x-12" style="margin-top: 20px;">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading bg-teal">
                      <h4 style="color: white;font-size: 20pt;">Daftar Muatan<span class="right" style="color : #9B2335; font-weight: bold; text-align: right; padding-right: 10px;">Terisi : <?= $cek_isi ?></span></h4>
                    </div>
